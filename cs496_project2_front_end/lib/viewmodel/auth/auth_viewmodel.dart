      ...
      if (email == '') {
        ...
        fetchUserByEmail(email).then((value) async {
          if (value == null) {
            ...
            print(userByUserModel.u_id.toString() +
                ' ' +
                userByUserModel.name +
                ' ' +
                userByUserModel.profile_pic +
                ' ' +
                userByUserModel.email +
                ' ' +
                userByUserModel.password +
                ' ' +
                userByUserModel.birthdate);
